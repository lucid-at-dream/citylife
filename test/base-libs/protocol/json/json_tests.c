...
TEST_CASE(test_parse_json_with_nested_dictionaries, {
    ...
    assertion_error +=
            assert_str_equals("String in first degree dictionary matches", ((json_object *)map_get(parsed, "name"))->content.data, "auth");
    assertion_error += assert_str_equals("String in first degree dictionary matches",
                                         ((json_object *)map_get(parsed, "__doc__"))->content.data, "Authentication service");
    ...
    assertion_error += assert_str_equals("String in third degree dictionary matches",
    ...
    assertion_error += assert_str_equals("String in fourth degree dictionary matches",
                                         ((json_object *)map_get(user_param, "type"))->content.data, "string");
    assertion_error += assert_str_equals("String in fourth degree dictionary matches",
                                         ((json_object *)map_get(user_param, "__doc__"))->content.data, "The username");

    map *pass_param = ((json_object *)map_get(login, "pass"))->content.object;
    assert_not_null("pass param exists", pass_param);
    assertion_error += assert_str_equals("String in fourth degree dictionary matches",
                                         ((json_object *)map_get(pass_param, "type"))->content.data, "string");
    assertion_error += assert_str_equals("String in fourth degree dictionary matches",
                                         ((json_object *)map_get(pass_param, "__doc__"))->content.data, "The password");
    ...
    assertion_error += assert_str_equals("String in fourth degree dictionary matches",
                                         ((json_object *)map_get(token_param, "type"))->content.data, "string");
    assertion_error += assert_str_equals("String in fourth degree dictionary matches",
                                         ((json_object *)map_get(token_param, "__doc__"))->content.data, "The session token");
