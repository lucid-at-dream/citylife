...
TEST_SUITE(
        ...
        // RUN_TEST("Test the comparison count of find operations after insertion of several random elements.", &test_tree_insert_random_assert_logarithmic_comparison_count),
)
