...
double angle_v( GIMS_Point &v1, GIMS_Point &v2 ){
    ...
    double dp = v1.x*v2.x + v1.y*v2.y,
           nv1= sqrt(v1.x*v1.x+v1.y*v1.y),
           nv2= sqrt(v2.x*v2.x+v2.y*v2.y),
           cosine = dp/(nv1*nv2);
...
int asdfcmp(const void *a, const void *b){
    ...
    double ang1 = atan2( p1->y - map0->y, map0->x - p1->x ),
           ang2 = atan2( p2->y - map0->y, map0->x - p2->x );
